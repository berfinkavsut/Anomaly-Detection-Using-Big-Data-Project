...
# def get_dataframe(interface,packet_amount,timeout):
#     cap = live_network_data(interface,packet_amount,timeout)
#     total_length = len(cap)


#     # creating the colums for the dataframe
#     col_names = [
...
# if __name__ == "__main__":
#     df  = live_network_data("Wi-Fi", 5)

 
#     # pd.set_option('display.max_columns', None)
#     # pd.set_option('display.width', None)
#     print(df)
#     # df.to_excel (r'C:\Users\sevki\Desktop\export_dataframe2.xlsx',  sheet_name='Your sheet name',  index = False)
