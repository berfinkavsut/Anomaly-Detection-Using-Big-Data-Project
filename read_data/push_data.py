...
#
# kafkaValue = json.dumps({"a":1, "b":2}, separators=(',', ':'))
# future = producer.send(
#     topic="sttreaming", # <-- just string
#     key=bytes("zuko", encoding='utf8'), # <-- encoding='utf8'
...
producer = KafkaProducer(api_version=(0, 10, 0), value_serializer=lambda m: json.dumps(m).encode('ascii'))
